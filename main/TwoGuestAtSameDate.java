...
public class TwoGuestAtSameDate {
    ...
    public static void main(String[] args) {
        ...
        Rooms room5 = new SingleBed.SingleBedBuilder().setRoomNumber("A105").setRoomPrice(2500).setCapacity(2).setServiceCharge(400).setRoomStatus(true).setRoomType("SingleBed").build();
